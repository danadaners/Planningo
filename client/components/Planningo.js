  ...
  return (
    <div className="about-wrapper">
      ...
      <div className="about-intro">
        ...
        <p>
          the app for the group that likes to get things done.
      ...
      <div className="body">
        <Fade bottom duration={700}>
          <div className="step list">
            ...
            <p>
              Customize your tasks and shopping lists with categories, icons,
              and more.
            </p>
            <img
          ...
          <div className="step newtask">
            ...
            <p>
              For those members who need the extra push, reward points can be
              set for each task.
            </p>
            <img
          ...
          <div className="step calendar">
            ...
            <p>
              Easily check the status of your group's tasks and due dates in an
